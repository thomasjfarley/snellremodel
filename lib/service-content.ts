...
export const kitchenContent: ServiceDetailContent = {
  ...
  serviceItems: [
    { icon: 'bi-grid', title: 'Cabinet Installation', desc: 'New cabinets, refacing plans, and storage upgrades that improve function and keep the kitchen organized.', img: '/images/cabinet-painting-south-jordan-after.jpg' },
    { icon: 'bi-bounding-box', title: 'Countertop Upgrades', desc: 'Replace worn tops with durable surfaces sized, templated, and installed for a clean finished fit.', img: '/images/bathroom-remodel-cottonwood-heights-after.jpg' },
    { icon: 'bi-arrows-move', title: 'Layout Changes', desc: 'Rework traffic flow, island placement, and work zones so the space feels more open and usable.', img: '/images/home-remodel-salt-lake-city-during.jpg' },
    { icon: 'bi-plug', title: 'Appliance Integration', desc: 'Prep for new ranges, refrigerators, dishwashers, and venting with coordinated electrical and finish work.', img: '/images/home-remodel-salt-lake-city-after.jpg' },
    { icon: 'bi-lightbulb', title: 'Lighting & Fixtures', desc: 'Update pendants, under-cabinet lighting, plumbing fixtures, and other details that sharpen the finished look.', img: '/images/interior-paint-entry-salt-lake-city.jpg' },
    { icon: 'bi-brush', title: 'Trim & Finishes', desc: 'Backsplashes, paint touchups, trim details, and punch-list work that make the remodel feel complete.', img: '/images/garage-remodel-sandy-cedar-wall.jpg' },
  ],
  process: [
...
export const bathroomContent: ServiceDetailContent = {
  ...
  ctaLabel: 'Get a Free Estimate',
  serviceItems: [
    { icon: 'bi-grid-3x3-gap', title: 'Tile Installation', desc: 'Floor, shower, and backsplash tile installed with straight lines, clean transitions, and durable setting materials.', img: '/images/bathroom-remodel-cottonwood-heights-after.jpg' },
    { icon: 'bi-columns-gap', title: 'Vanity & Storage', desc: 'Replace dated vanities, mirrors, and storage so the room works better and looks more polished.', img: '/images/bathroom-remodel-cottonwood-heights-after.jpg' },
    { icon: 'bi-droplet', title: 'Shower & Tub Updates', desc: 'New surrounds, shower conversions, and tub updates that improve function and visual impact.', img: '/images/bathroom-remodel-cottonwood-heights-after.jpg' },
    { icon: 'bi-lightbulb', title: 'Fixture Replacements', desc: 'Install updated faucets, lighting, hardware, and accessories that tie the remodel together.', img: '/images/bathroom-remodel-cottonwood-heights-after.jpg' },
    { icon: 'bi-square-half', title: 'Flooring & Trim', desc: 'Water-resistant flooring, base, casing, and finish trim selected to hold up in high-moisture spaces.', img: '/images/bathroom-remodel-cottonwood-heights-after.jpg' },
    { icon: 'bi-wind', title: 'Ventilation & Finishes', desc: 'Better exhaust, moisture-resistant finishes, and final paint details that protect the room over time.', img: '/images/bathroom-remodel-cottonwood-heights-after.jpg' },
  ],
  process: [
...
export const basementContent: ServiceDetailContent = {
  ...
  ctaLabel: 'Get a Free Estimate',
  serviceItems: [
    { icon: 'bi-layout-three-columns', title: 'Framing & Layout', desc: 'Build rooms, storage zones, and open living areas with a layout that makes the basement feel intentional.', img: '/images/basement-remodel-west-jordan-progress.jpg' },
    { icon: 'bi-shield-check', title: 'Insulation Planning', desc: 'Improve comfort with basement wall and ceiling prep that supports a more finished, livable environment.', img: '/images/basement-remodel-west-jordan-progress.jpg' },
    { icon: 'bi-grid-3x3', title: 'Drywall & Texture', desc: 'Hang, finish, and texture walls and ceilings so the basement blends with the rest of your home.', img: '/images/basement-remodel-west-jordan-after.jpg' },
    { icon: 'bi-grid-3x2-gap', title: 'Flooring Installation', desc: 'Install flooring suited to basement conditions, from LVP to carpet and other durable finished surfaces.', img: '/images/basement-remodel-west-jordan-after.jpg' },
    { icon: 'bi-door-open', title: 'Egress Considerations', desc: 'Plan around bedroom conversions and access requirements so the finished space is safe and functional.', img: '/images/basement-remodel-taylorsville-after.jpg' },
    { icon: 'bi-lightbulb', title: 'Trim & Lighting', desc: 'Add baseboards, doors, recessed lighting, and finishing touches that make the space feel move-in ready.', img: '/images/basement-remodel-west-jordan-after.jpg' },
  ],
  process: [
...
export const bedroomContent: ServiceDetailContent = {
  ...
  ctaLabel: 'Get a Free Estimate',
  serviceItems: [
    { icon: 'bi-door-closed', title: 'Closet Builds', desc: 'Build or rework closet storage so the room feels less cluttered and more functional.', img: '/images/garage-remodel-sandy-cedar-wall.jpg' },
    { icon: 'bi-arrows-angle-expand', title: 'Layout Adjustments', desc: 'Shift walls, openings, or room flow when a better layout makes the space more usable.', img: '/images/garage-remodel-sandy-during.jpg' },
    { icon: 'bi-border-width', title: 'Trim & Millwork', desc: 'Upgrade baseboards, casing, accent trim, and other finish carpentry that sharpens the room.', img: '/images/garage-remodel-sandy-cedar-wall-2.jpg' },
    { icon: 'bi-grid-1x2', title: 'Flooring Updates', desc: 'Install flooring that fits the room and ties it visually to adjacent spaces in the home.', img: '/images/garage-remodel-sandy-after-2.jpg' },
    { icon: 'bi-lightbulb', title: 'Lighting Changes', desc: 'Add better fixture placement, switches, and lighting upgrades that improve comfort and function.', img: '/images/garage-remodel-sandy-after.jpg' },
    { icon: 'bi-brush', title: 'Paint & Finish Work', desc: 'Complete the remodel with smooth walls, crisp lines, and final paint details that elevate the room.', img: '/images/garage-remodel-sandy-after-3.jpg' },
  ],
  process: [
...
export const flooringContent: ServiceDetailContent = {
  ...
  ctaLabel: 'Get a Free Estimate',
  serviceItems: [
    { icon: 'bi-tree', title: 'Hardwood Flooring', desc: 'Install hardwood floors that bring warmth and long-term value to living spaces, bedrooms, and hallways.', img: '/images/garage-remodel-sandy-after.jpg' },
    { icon: 'bi-grid', title: 'LVP Installation', desc: 'Luxury vinyl plank floors installed for durability, water resistance, and a clean modern finish.', img: '/images/laundry-room-remodel-taylorsville-after-2.jpg' },
    { icon: 'bi-grid-3x3-gap', title: 'Tile Flooring', desc: 'Tile floors laid with proper spacing, transitions, and substrate prep for bathrooms, kitchens, and entries.', img: '/images/bathroom-remodel-cottonwood-heights-after.jpg' },
    { icon: 'bi-square', title: 'Carpet Installation', desc: 'Soft-surface flooring installed for comfort in bedrooms, basements, and other lower-traffic spaces.', img: '/images/home-remodel-salt-lake-city-after.jpg' },
    { icon: 'bi-hammer', title: 'Subfloor Preparation', desc: 'Leveling, patching, and prep work that helps finished floors perform better and last longer.', img: '/images/basement-remodel-west-jordan-progress.jpg' },
    { icon: 'bi-border-style', title: 'Transitions & Base', desc: 'Clean edges, transition strips, and base trim details that make the installation look complete.', img: '/images/garage-remodel-sandy-after-2.jpg' },
  ],
  process: [
...
export const paintContent: ServiceDetailContent = {
  ...
  ctaLabel: 'Get a Free Estimate',
  serviceItems: [
    { icon: 'bi-house', title: 'Interior Painting', desc: 'Walls, ceilings, trim, and doors painted to a professional standard with careful prep and protection.', img: '/images/interior-paint-murray-after.jpg' },
    { icon: 'bi-sun', title: 'Exterior Painting', desc: 'Weather-ready finishes that protect siding, trim, and other exterior surfaces while boosting curb appeal.', img: '/images/exterior-paint-herriman-after.jpg' },
    { icon: 'bi-grid', title: 'Cabinet Painting', desc: 'Refresh kitchen and bathroom cabinets with a durable process that delivers a clean, updated look.', img: '/images/cabinet-painting-south-jordan-after.jpg' },
    { icon: 'bi-palette', title: 'Color Consultation', desc: 'Get help choosing colors that fit your lighting, materials, and the style of your home.', img: '/images/interior-paint-salt-lake-city-after.jpg' },
    { icon: 'bi-columns', title: 'Accent Walls', desc: 'Add contrast, depth, or personality with accent wall planning and precise finish work.', img: '/images/interior-paint-entry-salt-lake-city.jpg' },
    { icon: 'bi-building', title: 'Commercial Painting', desc: 'Professional painting for offices, retail spaces, and light commercial interiors on a practical schedule.', img: '/images/exterior-paint-salt-lake-city-after.jpg' },
  ],
  process: [
...
export const drywallContent: ServiceDetailContent = {
  ...
  ctaLabel: 'Get a Free Estimate',
  serviceItems: [
    { icon: 'bi-plus-square', title: 'New Installation', desc: 'Full drywall installation for room conversions, additions, and new framed spaces.', img: '/images/drywall-repair-holladay-after.jpg' },
    { icon: 'bi-tools', title: 'Drywall Repair', desc: 'Repair holes, cracks, and damaged areas so they blend into the surrounding wall or ceiling.', img: '/images/drywall-repair-holladay-after.jpg' },
    { icon: 'bi-droplet', title: 'Water Damage Repair', desc: 'Replace affected drywall after leaks or flooding and prep the surface for texture and paint.', img: '/images/water-damage-repair-draper-after.jpg' },
    { icon: 'bi-grid-3x3-gap', title: 'Texture Matching', desc: 'Match orange peel, knockdown, skip trowel, and other existing wall textures as closely as possible.', img: '/images/drywall-repair-holladay-after.jpg' },
    { icon: 'bi-layers', title: 'Skim Coating', desc: 'Smooth rough or dated surfaces with skim coating for a cleaner, more modern finished wall.', img: '/images/drywall-repair-holladay-after.jpg' },
    { icon: 'bi-square', title: 'Ceiling Work', desc: 'Install and repair ceiling drywall, including texture repair and smoothing for damaged areas.', img: '/images/drywall-repair-holladay-after.jpg' },
  ],
  process: [
...
export const waterDamageContent: ServiceDetailContent = {
  ...
  ctaLabel: 'Get a Free Estimate',
  serviceItems: [
    { icon: 'bi-search', title: 'Damage Assessment', desc: 'Review affected walls, ceilings, and finishes to understand the visible repair scope after the source is addressed.', img: '/images/water-damage-repair-draper-before.jpg' },
    { icon: 'bi-hammer', title: 'Selective Demo', desc: 'Remove damaged drywall, trim, and other compromised materials without disturbing more of the room than necessary.', img: '/images/water-damage-repair-draper-during.jpg' },
    { icon: 'bi-grid-3x3', title: 'Drywall Replacement', desc: 'Install new drywall where needed and prep the repaired areas for finishing and texture.', img: '/images/water-damage-repair-draper-during.jpg' },
    { icon: 'bi-bricks', title: 'Texture Restoration', desc: 'Recreate the surrounding wall or ceiling texture so new work blends with existing surfaces.', img: '/images/water-damage-repair-draper-after.jpg' },
    { icon: 'bi-brush', title: 'Prime & Paint', desc: 'Prime repaired areas and finish with paint so the room looks whole again once restoration is complete.', img: '/images/water-damage-repair-draper-after-2.jpg' },
    { icon: 'bi-house-check', title: 'Finish Coordination', desc: 'Reinstall trim and complete final detail work so the repaired space is ready to return to normal use.', img: '/images/water-damage-repair-draper-final.jpg' },
  ],
  process: [
...
export const demoContent: ServiceDetailContent = {
  ...
  ctaLabel: 'Get a Free Estimate',
  serviceItems: [
    { icon: 'bi-house-dash', title: 'Interior Demo', desc: 'Remove walls, cabinets, flooring, and finishes that need to come out before remodeling can begin.', img: '/images/exterior-demo-riverton-before.jpg' },
    { icon: 'bi-scissors', title: 'Selective Demo', desc: 'Targeted demolition for kitchens, bathrooms, basements, and other spaces where only part of the room is changing.', img: '/images/exterior-demo-riverton-during.jpg' },
    { icon: 'bi-trash3', title: 'Debris Removal', desc: 'Haul away demolition debris so the site stays cleaner and the next phase of work can start faster.', img: '/images/carport-conversion-bountiful-progress.jpg' },
    { icon: 'bi-cone-striped', title: 'Site Preparation', desc: 'Prep the work area for framing, drywall, flooring, or finish crews after demolition is complete.', img: '/images/carport-conversion-bountiful-framing.jpg' },
    { icon: 'bi-shield', title: 'Dust & Surface Protection', desc: 'Use practical containment and protection measures to reduce mess in nearby areas of the home.', img: '/images/carport-conversion-bountiful-before.jpg' },
    { icon: 'bi-layout-text-window', title: 'Remodel Readiness', desc: 'Leave the space stripped, organized, and ready for the next construction step without unnecessary delays.', img: '/images/carport-conversion-bountiful-after.jpg' },
  ],
  process: [
