...
const fallbackReviews: Review[] = [
  {
    author: 'Sarah M.',
    rating: 5,
    text: "Snel Remodeling Services did an incredible job painting our entire home interior. The attention to detail was outstanding — clean lines, no drips, and they left everything spotless. Highly recommend.",
    time: '2 months ago',
  },
  {
    author: 'James R.',
    rating: 5,
    text: "We hired Snel Remodeling Services to remodel our kitchen and couldn't be happier. Everything from the cabinets to the finishing work was done with real craftsmanship. Worth every penny.",
    time: '3 months ago',
  },
  {
    author: 'Linda K.',
