...
const projects: Project[] = [
  ...
  },
  {
    ...
    city: 'Draper',
    stage: 'Before',
    desc: 'Existing bathroom before demolition and finish upgrades.',
    img: '/images/bathroom-remodel-millcreek-before.jpg',
    alt: 'Bathroom remodel before photo in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
    city: 'Draper',
    stage: 'Before',
    desc: 'Second before angle showing original condition before work began.',
    img: '/images/bathroom-remodel-cottonwood-heights-before.jpg',
    alt: 'Bathroom before remodeling, second angle in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
    city: 'Draper',
    stage: 'During',
    desc: 'Bathroom remodel in progress midway through transformation.',
    img: '/images/bathroom-remodel-cottonwood-heights-during.jpg',
    alt: 'Bathroom remodel in progress in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
    ...
    alt: 'Completed bathroom remodel in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
    city: 'Draper',
    stage: 'After',
    desc: 'Finished bathroom showing upgraded materials and clean layout.',
    img: '/images/bathroom-remodel-sandy-after.jpg',
    alt: 'Bathroom remodel after photo, second view in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
    city: 'Millcreek',
    stage: 'Before',
    desc: 'Original bathroom condition before the Millcreek remodel began.',
    img: '/images/bathroom-remodel-sandy-before.jpg',
    alt: 'Bathroom before remodeling in Millcreek, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
  ...
  },
  {
    ...
    city: 'West Jordan',
    stage: 'During',
    desc: 'Basement build-out underway with framing and layout in progress.',
  ...
  },
  {
    ...
    city: 'West Jordan',
    stage: 'During',
    desc: 'Basement remodeling continuing through the build-out phase.',
    img: '/images/basement-remodel-west-jordan-progress.jpg',
    alt: 'Basement remodel progress photo in West Jordan, UT',
  },
  {
