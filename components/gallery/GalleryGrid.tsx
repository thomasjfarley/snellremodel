...
const projects: Project[] = [
  ...
  },
  {
    ...
    city: 'Draper',
    stage: 'After',
    desc: 'Repaired interior after drywall, texture, and finish restoration.',
    img: '/images/water-damage-repair-draper-after.jpg',
    alt: 'Completed water damage repair in Draper, UT',
  },
  {
    title: 'Water Damage Repair',
    category: 'Restore',
    city: 'Draper',
    stage: 'After',
    desc: 'Second completed restoration view showing the finished repair.',
    img: '/images/water-damage-repair-draper-after-2.jpg',
    alt: 'Second finished water damage repair photo from Draper, UT',
  },
  {
    title: 'Water Damage Repair',
    category: 'Restore',
    city: 'Draper',
    stage: 'After',
    desc: 'Final finished view of the restored area in Draper.',
    img: '/images/water-damage-repair-draper-final.jpg',
    alt: 'Final water damage repair results in Draper, UT',
  },
  {
