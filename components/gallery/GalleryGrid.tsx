...
const projects: Project[] = [
  ...
  },
  {
    ...
    alt: 'Bathroom before remodeling in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
  ...
  },
  {
    ...
    city: 'Draper',
    stage: 'During',
    desc: 'Continued progress on the bathroom remodel.',
    img: '/images/bathroom-remodel-cottonwood-heights-before.jpg',
    alt: 'Bathroom remodel progress in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
    city: 'Draper',
    stage: 'During',
    desc: 'Bathroom nearing completion with finishes being applied.',
    img: '/images/bathroom-remodel-sandy-after.jpg',
    alt: 'Bathroom remodel nearing completion in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
    city: 'Draper',
    stage: 'After',
    desc: 'Fully completed bathroom remodel with new sink, toilet, and fixtures.',
    img: '/images/bathroom-remodel-cottonwood-heights-after.jpg',
    alt: 'Completed bathroom remodel with new fixtures in Draper, UT',
  },
  {
    title: 'Bathroom Remodel',
    category: 'Remodel',
